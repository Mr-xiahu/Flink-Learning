...
class MutilStreamJoin_Redis_01 {
    public static void main(String[] args) throws Exception {
        ...
        MyRedisProcessAllWindowFunction processFunction = new MyRedisProcessAllWindowFunction("redis_test_1,redis_test_2,redis_test_3,redis_test_4,redis_test_5,redis_test_6,redis_test_7,redis_test_8,redis_test_9,redis_test_10,redis_test_11,redis_test_12," +
