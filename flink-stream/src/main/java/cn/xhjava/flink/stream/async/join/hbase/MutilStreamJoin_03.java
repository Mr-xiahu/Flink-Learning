...
class MutilStreamJoin_03 {
    public static void main(String[] args) throws Exception {
        ...
        MyProcessAllWindowFunction processFunction = new MyProcessAllWindowFunction("lookup:realtime_dim_1,lookup:realtime_dim_2,lookup:realtime_dim_3," +
                "lookup:realtime_dim_4,lookup:realtime_dim_5");
        /* MyProcessAllWindowFunction processFunction = new MyProcessAllWindowFunction("lookup:realtime_dim_1");*/
