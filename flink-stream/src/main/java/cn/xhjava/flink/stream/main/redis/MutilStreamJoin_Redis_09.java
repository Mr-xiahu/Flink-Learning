...
import cn.xhjava.flink.stream.transfromfunction.CheckpointJoinRedisInstanceProcessFunction;
 ...
 * @create 2021/4/20
 * <p>
 * map() 内,在进行 checkpoint 时做join redis 多单机实例数据
 */

public class MutilStreamJoin_Redis_09 {
    public static void main(String[] args) throws Exception {
        ...
        CheckpointJoinRedisInstanceProcessFunction processFunction = new CheckpointJoinRedisInstanceProcessFunction(
        ...
        //CheckpointJoinRedisInstanceProcessFunction processFunction = new CheckpointJoinRedisInstanceProcessFunction("redis_test_1,redis_test_2,redis_test_3,redis_test_4,redis_test_5");
