...
import cn.xhjava.flink.stream.sink.RedisInstanceSink;
 ...
 * @create 2021/5/8
 * <p>
 * 消费kafka消息,落地到redis 多单机节点
 */
public class KafkaToRedisInstance {
    public static void main(String[] args) throws Exception {
        ...
        dataStream.addSink(new RedisInstanceSink(properties, columnList()));
