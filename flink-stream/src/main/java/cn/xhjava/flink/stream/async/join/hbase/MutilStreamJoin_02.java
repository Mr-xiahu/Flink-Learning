...
class MutilStreamJoin_02 {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Student4> resultStream2 = AsyncDataStream.orderedWait(resultStream, hbaseAsyncFunction2, 500, TimeUnit.MILLISECONDS, 1000);
        ...
        resultStream5.addSink(sinkFunction);
