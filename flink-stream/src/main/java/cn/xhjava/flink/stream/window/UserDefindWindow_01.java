 ...
 * @create 2021/4/26
 */
public class UserDefindWindow_01 extends WindowAssigner<Object, TimeWindow> {
    ...
    public UserDefindWindow_01(long size, long offset, WindowStagger windowStagger) {
    ...
    public static UserDefindWindow_01 of(Time size) {
        return new UserDefindWindow_01(size.toMilliseconds(), 0, WindowStagger.ALIGNED);
    }
}
