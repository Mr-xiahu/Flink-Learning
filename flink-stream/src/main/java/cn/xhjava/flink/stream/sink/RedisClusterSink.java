 ...
 */
@Slf4j
public class RedisClusterSink extends RichSinkFunction<OggMsg> implements CheckpointedFunction {
    ...
    public RedisClusterSink(Properties properties, LinkedList<String> columnList) {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        this.jedisCluster = RedisClusterUtils.getJedisCluster();
        this.pipelined = JedisClusterPipeline.pipelined(this.jedisCluster);
    }
